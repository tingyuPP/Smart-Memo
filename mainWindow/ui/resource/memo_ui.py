...
# Form implementation generated from reading ui file 'd:\study\NIS3366\Smart-Memo-Manager\mainWindow\ui\resource\memo.ui'
#
...
class Ui_memo(object):
    def setupUi(self, memo):
        ...
        self.textEdit.setGeometry(QtCore.QRect(10, 40, 391, 491))
        ...
        self.textBrowser.setGeometry(QtCore.QRect(410, 40, 391, 491))
...
from qfluentwidgets import CardWidget, CommandBar, EditableComboBox, LineEdit, StrongBodyLabel, TextBrowser, TextEdit
